...
export default function Detail() {
  ...
  const message = `Olá ${incident.name}, estou entrando em contaoto pois gostaria de ajudar no caso "${incident.title}" no valor de ${Intl.NumberFormat('pt-BR', {style: 'currency',currency: 'BRL'}).format(incident.value)}`;
